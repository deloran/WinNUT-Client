...
Partial Class Pref_Gui
    ...
    Private Sub InitializeComponent()
        ...
        Me.Lbl_MasterPassword = New System.Windows.Forms.Label()
        Me.Tb_MasterPassword = New System.Windows.Forms.TextBox()
        ...
        'Tab_Miscellanous
        '
        Me.Tab_Miscellanous.Controls.Add(Me.Tb_MasterPassword)
        Me.Tab_Miscellanous.Controls.Add(Me.Lbl_MasterPassword)
        ...
        'Lbl_MasterPassword
        '
        resources.ApplyResources(Me.Lbl_MasterPassword, "Lbl_MasterPassword")
        Me.Lbl_MasterPassword.Name = "Lbl_MasterPassword"
        '
        'Tb_MasterPassword
        '
        resources.ApplyResources(Me.Tb_MasterPassword, "Tb_MasterPassword")
        Me.Tb_MasterPassword.Name = "Tb_MasterPassword"
        Me.Tb_MasterPassword.UseSystemPasswordChar = True
        '
        'Pref_Gui
        '
    ...
    Friend WithEvents Tb_MasterPassword As TextBox
    Friend WithEvents Lbl_MasterPassword As Label
End Class
